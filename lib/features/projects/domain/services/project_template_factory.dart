    ...
    final (context, starterTasks, defaultRoles) = switch (category) {
      ProjectCategory.mobileApp => (
        ProjectContext(
          projectId: id,
          systemInstructions:
              'Build a production Flutter app following Feature-First Clean Architecture and SOLID principles.',
        ...
        [
          ProjectTask(
            ...
            description:
                'Establish domain, data, application, presentation modules.',
            createdAt: now,
          ),
          ProjectTask(
            id: 'task_2',
            ...
            description:
                'Configure GoRouter redirects and session persistence.',
            createdAt: now,
          ),
        ],
      ...
      ProjectCategory.website => (
        ProjectContext(
          projectId: id,
          systemInstructions:
              'Create a responsive web product landing page with high-contrast SaaS design.',
          techStack: const ['HTML5', 'Vanilla CSS', 'JavaScript'],
          keyRules: const [
            'WCAG AA Contrast',
            'Under 2s load time',
            'Vibrant glassmorphism aesthetics',
          ],
        ),
        [
          ProjectTask(
