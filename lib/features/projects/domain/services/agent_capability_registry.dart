  ...
  static ProjectAgent getAgentForRole(AgentRole role) {
    return switch (role) {
      AgentRole.coding => const ProjectAgent(
        ...
        systemInstructions:
            'You are an elite Flutter & Dart software architect. Write Clean Code following SOLID principles.',
        supportedTools: [
          'code_generation',
          'refactoring',
          'flutter_analyze',
      ...
      AgentRole.research => const ProjectAgent(
        ...
        systemInstructions:
            'You are a senior domain researcher. Analyze knowledge files and synthesize facts.',
      ...
      AgentRole.writing => const ProjectAgent(
        ...
        systemInstructions:
            'You craft compelling tech copy, user manuals, and production release notes.',
      ...
      AgentRole.design => const ProjectAgent(
        ...
        systemInstructions:
            'You generate design tokens, widget specs, and HIG/Material 3 layouts.',
      ...
      AgentRole.marketing => const ProjectAgent(
        ...
        systemInstructions:
            'You design SaaS launch strategies, SEO campaigns, and user funnel copy.',
      ...
      AgentRole.analysis => const ProjectAgent(
        ...
        systemInstructions:
            'You parse metrics, CSV logs, and compute project health analytics.',
